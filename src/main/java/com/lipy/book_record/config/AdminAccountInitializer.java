...
public class AdminAccountInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        member3.setPassword(passwordEncoder.encode("password3"));
        ...
        member4.setPassword(passwordEncoder.encode("password4"));
        ...
        member5.setPassword(passwordEncoder.encode("password5"));
        ...
        member6.setPassword(passwordEncoder.encode("password6"));
        ...
        member7.setPassword(passwordEncoder.encode("password7"));
        ...
        member8.setPassword(passwordEncoder.encode("password8"));
        ...
        member9.setPassword(passwordEncoder.encode("password9"));
        ...
        member10.setPassword(passwordEncoder.encode("password10"));
